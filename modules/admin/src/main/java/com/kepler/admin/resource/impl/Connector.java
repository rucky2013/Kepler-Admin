...
public class Connector {
	...
	public Connector(Serials serials, CuratorFramework client, InstanceContext context4service, TerminalStatusContext context4status, DependencyContext context4dependnecy) {
		super();
