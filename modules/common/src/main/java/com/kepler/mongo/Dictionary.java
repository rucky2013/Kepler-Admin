...
public interface Dictionary {
	...
	public final static String FIELD_SERVICES = "services";
	...
	public final static String FIELD_DEPENDENCY = "dependency";

	public final static String FIELD_HOST_LOCAL = "host_local";

	public final static String FIELD_HOST_LOCAL_SID = "host_local_sid";
	...
	public final static String FIELD_HOST_TARGET_SID = "host_target_sid";
	...
	public final static String FIELD_PERIOD_DAY = "day";

	public final static String FIELD_PERIOD_HOUR = "hour";

	public final static String FIELD_PERIOD_MINUTE = "minute";
